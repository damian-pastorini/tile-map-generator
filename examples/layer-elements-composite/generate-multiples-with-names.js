...
class GenerateMultiplesWithNames
{
    ...
    async execute()
    {
        for(let mapName of ['map-001', 'map-002', 'map-003']){
            ...
            await this.generators[mapName].fromElementsProvider({
                ...
                groundSpots: this.groundSpots
            });
            await this.generators[mapName].generate();
        }
...
if(require.main === module){
    (new GenerateMultiplesWithNames()).execute();
}

module.exports.GenerateMultiplesWithNames = GenerateMultiplesWithNames;
