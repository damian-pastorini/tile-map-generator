...
class GraphAlgorithms
{
    ...
    breadthFirstSearch(startNode, targetNode)
    {
        ...
        while(0 < queue.length){
            ...
            if(currentNode === targetNode){
                return this.reconstructPath(parent, startNode, targetNode);
            }
    ...
    reconstructPath(parent, startNode, targetNode)
    {
        let path = [];
    ...
    isNodeReachable(startNode, targetNode)
    {
        let path = this.breadthFirstSearch(startNode, targetNode);
        return 0 < path.length;
    }

    calculateShortestDistance(startNode, targetNode)
    {
        let path = this.breadthFirstSearch(startNode, targetNode);
        if(0 === path.length){
            return Infinity;
