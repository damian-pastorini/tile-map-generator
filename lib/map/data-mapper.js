...
class MapDataMapper
{
    ...
    static fromElementsProvider(elementsProvider)
    {
        return {
            ...
            borderInnerCornersTiles: elementsProvider.borderInnerCornersTiles,
    ...
    static removeEmptyGroundTiles(providerData)
    {
        if(!providerData.groundTile){
            delete providerData.groundTile;
        }
        if(!sc.isNotEmptyArray(providerData.groundTiles)){
            delete providerData.groundTiles;
        }
        return providerData;
    }
    ...
    static fromProvider(props, mapName, elementsProvider)
    {
        return Object.assign(
            ...
            MapDataMapper.removeEmptyGroundTiles(MapDataMapper.fromElementsProvider(elementsProvider))
        );
    }
