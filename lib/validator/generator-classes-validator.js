...
class GeneratorClassesValidator extends OptionsValidator
{
    ...
    validateAllGeneratorClasses(testDataPath)
    {
        ...
        let multipleByLoaderValidation = this.validateMultipleByLoaderGenerator(testDataPath);
        let associationsValidation = this.validateMultipleWithAssociationsByLoaderGenerator(testDataPath);
        return {
            isValid: objectLoaderValidation.isValid && compositeLoaderValidation.isValid && multipleByLoaderValidation.isValid && associationsValidation.isValid,
    ...
    validateMultipleByLoaderGenerator(testDataPath)
    {
        let validation = {
            isValid: true,
