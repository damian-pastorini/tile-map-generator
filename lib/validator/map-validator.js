...
class MapValidator
{
    ...
    validateLayerStructure(layer, expectedWidth, expectedHeight, layerIndex)
    {
        ...
        if(layerHeight !== expectedHeight){
            this.logValidationError('Layer '+layerName+' height '+layerHeight+' does not match map height '+expectedHeight);
            return false;
        }
        ...
        if(layerData.length !== expectedDataLength){
            this.logValidationError('Layer '+layerName+' data length '+layerData.length+' does not match expected '+expectedDataLength);
            return false;
        }
