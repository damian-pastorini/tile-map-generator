...
const { AssociatedMaps } = require('./generator/associated-maps');
...
class RandomMapGenerator
{
    ...
    static async fromComposite(props)
    {
        ...
        let mapData = MapDataMapper.fromProvider(props, mapFileName, elementsProvider);
    ...
    async generate()
    {
        ...
        let generatedMap = sc.deepJsonClone(map);
        await AssociatedMaps.generate(generatedMap, this.mapFileName, this.rootFolder, this.associatedMapsConfig, this);
        return generatedMap;
    }
