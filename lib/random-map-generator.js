...
class RandomMapGenerator
{
    ...
    generateRandomMainPath()
    {
        ...
        for(let i = 0; i < this.mainPathSize; i++){
            ...
            let plusOnX = 0 === this.mainPathStart.y || this.mainPathStart.y === this.mapHeight - 1;
            // top or bottom edge
            x += (plusOnX ? i : 0);
            // right or left edge
            y += (plusOnX ? 0 : i);
    ...
    connectPaths()
    {
        ...
        for(let layer of this.additionalLayers){
            ...
            let previousPathTilePosition = false;
            for(let pathTilePosition of pathTilePositions){
                if(this.isBorder(pathTilePosition)){
                    continue;
                }
                let endPathTilePosition = this.mainPathStart
                    ? this.mainPathStart
                    : previousPathTilePosition ? previousPathTilePosition : pathTilePosition;
                ...
                previousPathTilePosition = pathTilePosition;
            }
        }
