...
class RandomMapGenerator
{
    ...
    fixInnerWallsPatterns(layerData, tilesShortcuts, mapWidth, mapHeight)
    {
        ...
        let {sML, sMC, sMR, sBL, sBC, sBR, cTR, cTL, cBR, cBL, sTC, sTL, sTR} = tilesShortcuts;
    ...
    applyBorderEndTiles(bordersLayer, pathTileIndexes, removedBorders, spotTiles, layerWidth, layerHeigh)
    {
        ...
        bordersLayer = this.rotateLayer90Degrees(bordersLayer, layerWidth, layerHeigh);
        this.replaceSequences(
            bordersLayer,
            [
                [[cBR, cTR, sMR], [cBR, sMR, sMR]],
        ...
        bordersLayer = this.rollbackRotation90Degrees(bordersLayer, layerHeigh, layerWidth);
        return bordersLayer;
    }
