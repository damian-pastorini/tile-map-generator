...
class RandomMapGenerator
{
    ...
    cleanUpMapBorders(bordersLayer, tilesShortcuts)
    {
        ...
        for(let c = 0; c < this.mapWidth; c++){
            ...
            let currentBottomValue = bordersLayer[this.tileIndexByRowAndColumn(
                this.mapHeight - 1,
                c
            )];
        ...
        for(let r = 0; r < this.mapHeight; r++){
            ...
            let currentRightValue = bordersLayer[this.tileIndexByRowAndColumn(
                r,
                this.mapWidth - 1
            )];
