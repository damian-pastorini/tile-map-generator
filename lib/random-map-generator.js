...
class RandomMapGenerator
{
    ...
    generateLayersList()
    {
        ...
        if(this.splittedBordersLayer && 0 < this.splittedBordersLayer.length){
            this.staticLayers.push(this.generateLayerWithData('path-borders', this.splittedBordersLayer));
        }
    ...
    connectPaths()
    {
        ...
        this.splittedBordersLayer = this.applySplitBordersAndCorners(
        ...
        if(!this.splitBordersInLayers){
            this.pathLayerData = this.splittedBordersLayer;
        }
    ...
    {
        let pathFullLayerData = this.splitBordersInLayers ? this.splittedBordersLayer : this.pathLayerData;
        for(let y = 0; y < this.mapHeight; y++){
            for(let x = 0; x < this.mapWidth; x++){
                let pointIndex = y * this.mapWidth + x;
    ...
    cleanUpMapBorders()
    {
        let bordersLayer = this.splitBordersInLayers ? this.splittedBordersLayer : this.pathLayerData;
        ...
        for(let spotKey of Object.keys(this.groundSpots)){
            ...
            for(let i = 0; i < spotsQuantity; i++){
                ...
                if(groundSpotConfig.applyCornersTiles){
                    spotLayer = this.fixEmptyTilesBetweenBordersAndSpotGround(
                        spotLayer,
    ...
    fixEmptyTilesBetweenBordersAndSpotGround(spotLayer, additionalBordersLayer, width, height, spotTile)
    {
