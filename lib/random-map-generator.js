...
class RandomMapGenerator
{
    ...
    generateSpots()
    {
        for(let spotKey of Object.keys(this.groundSpots)){
            ...
            if(groundSpotConfig.applyCornersTiles){
                ...
                spotTilesShortcuts = this.mapTilesShortcuts(
                    tilesKey,
                    spotTile,
    ...
    /**
     * @returns {TilesShortcuts|boolean}
     */
    mapTilesShortcuts(tilesKey, mainTile, propertiesMapper)
    {
        let propertiesMapperShortCut = 'path' === tilesKey ? '' : tilesKey+'-';
    ...
    {
        let wangset = this.fetchWangsetByKey(tilesKey);
        // map wangset data:
        return {surroundingTilesPosition: {}, cornersPosition: {}};
    }

    fetchWangsetByKey(wangsetKey)
    {
        return false;
    }
