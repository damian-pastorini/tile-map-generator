            ...
            for(let x = 0; x < width; x++){
                if(0 !== row[x]){
                    if(-1 !== firstNonZeroIndex){
                        let hasSpotTile = 0 !== spotLayerClone[rowStart + firstNonZeroIndex]
                            || 0 !== spotLayerClone[rowStart + x];
                        if(hasSpotTile){
        ...
        for(let x = 0; x < width; x++){
            ...
            for(let y = 0; y < height; y++){
                ...
                if(0 !== mergedLayer[index]){
                    if(-1 !== firstNonZeroIndex){
                        let hasSpotTile = 0 !== spotLayerClone[firstNonZeroIndex * width + x]
                            || 0 !== spotLayerClone[y * width + x];
                        if(hasSpotTile){
