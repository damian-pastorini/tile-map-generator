...
class RandomMapGenerator
{
    ...
    generateLayersList()
    {
        ...
        if(sc.isArray(this.pathInnerWallsLayer) && 0 < this.pathInnerWallsLayer.length){
            this.staticLayers.push(
                this.generateLayerWithData('path-borders-inner-walls'+this.splitBordersLayerSuffix, this.pathInnerWallsLayer)
            );
        }
    ...
    async createSpotOuterWalls(bordersLayer, tilesKey, spotTiles, width, height, wallsLayer)
    {
