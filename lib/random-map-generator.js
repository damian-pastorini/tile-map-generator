...
class RandomMapGenerator
{
    ...
    resetInstance(props)
    {
        ...
        this.spotLayersBuilder = new SpotLayersBuilder(this.geometryCalculator, this.tileVariationsApplier, this.layerDataFactory);
        this.spotBorderAnalyzer = new SpotBorderAnalyzer(this.layerDataFactory);
        this.spotFillProcessor = new SpotFillProcessor(this.layerDataFactory, this.geometryCalculator, this.mapLayersComposer);
        ...
        this.spotGenerator = new SpotGenerator(this.spotLayersBuilder, this.spotFillProcessor, this.spotBordersAndCorners, this.spotBorderAnalyzer, this.wallsGenerator, this.tileShortcutsMapper, this);
        this.positionFinder = new PositionFinder(this);
        this.mainPathGenerator = new MainPathGenerator(this.tilePositionCalculator, this.returnPointWriter, this.layerDataFactory, this.mapGridBuilder);
        this.pathRouter = new PathRouter(this.pathFinder, this.geometryCalculator);
        this.pathTilesFinisher = new PathTilesFinisher(this.bordersPatterns, this.layerDataFactory, this.mapGridBuilder, this.wallsGenerator, this.geometryCalculator, this.tilePositionCalculator);
        this.pathExpander = new PathExpander(this.layerDataFactory, this.mapGridBuilder);
        this.pathConnector = new PathConnector(this.pathRouter, this.mainPathGenerator, this.pathTilesFinisher, this.spotBordersAndCorners, this.layerDataFactory, this.pathExpander, this);
    }
