...
class RandomMapGenerator
{
    ...
    static async fromComposite(map)
    {
    ...
    generate()
    {
        ...
        this.fileHandler.copyTilesheet(this.fileHandler.joinPaths('generated', this.tileSheetPath), this.tileSheetName, this.generatedFolder);
