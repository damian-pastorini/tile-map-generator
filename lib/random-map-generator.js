...
class RandomMapGenerator
{
    ...
    generateSpots()
    {
        for(let spotKey of Object.keys(this.groundSpots)){
            ...
            let groundSpotsPropertiesMapper = this.populateSpotPropertiesMapper(tilesKey);
            ...
            if(groundSpotConfig.applyCornersTiles && groundSpotsPropertiesMapper){
    ...
    populateSpotPropertiesMapper(tilesKey) {
        ...
        return groundSpotsPropertiesMapper;
    }
