...
class RandomMapGenerator
{
    ...
    connectPaths()
    {
        ...
        /* @TODO - BETA - Apply paths inner walls.
        if(this.applyPathsInnerWalls){
            this.pathInnerWallsLayer = this.createSpotInnerWalls(this.splitBorderLayer, 'cave', spotTilesShortcuts);
        }
        */
    ...
    applyBordersAndCornersTiles(layerData, mapWidth, mapHeight, tilesShortcuts)
    {
        ...
        this.replaceSequence(layerData, [p, 0, p], [p, p, p], mapWidth);
        this.replaceSequence(layerData, [0, p], [sML, p], mapWidth);
        this.replaceSequence(layerData, [p, 0], [p, sMR], mapWidth);
        // rotate the path:
        layerData = this.rotateLayer90Degrees(layerData, mapWidth, mapHeight);
        this.replaceSequence(layerData, [p, 0, p], [p, p, p], mapHeight);
        this.replaceSequence(layerData, [0, p], [sTC, p], mapHeight);
        this.replaceSequence(layerData, [p, 0], [p, sBC], mapHeight);
        // rollback rotation:
        layerData = this.rollbackRotation90Degrees(layerData, mapHeight, mapWidth);
        // add corners:
        this.replaceSequence(layerData, [0, sTC], [sTL, sTC], mapWidth);
        this.replaceSequence(layerData, [sTC, 0], [sTC, sTR], mapWidth);
        this.replaceSequence(layerData, [0, sBC], [sBL, sBC], mapWidth);
        this.replaceSequence(layerData, [sBC, 0], [sBC, sBR], mapWidth);
        this.replaceSequence(layerData, [sBC, sML], [sBC, cBL], mapWidth);
        this.replaceSequence(layerData, [sTC, sML], [sTC, cTL], mapWidth);
        this.replaceSequence(layerData, [sMR, sBC], [cBR, sBC], mapWidth);
        this.replaceSequence(layerData, [sMR, sTC], [cTR, sTC], mapWidth);
        // rotate to add upper corners:
        layerData = this.rotateLayer90Degrees(layerData, mapWidth, mapHeight);
        this.replaceSequence(layerData, [sML, 0], [sML, sBL], mapHeight);
        this.replaceSequence(layerData, [0, sML], [sTL, sML], mapHeight);
        this.replaceSequence(layerData, [cBR, 0], [cBR, sBL], mapHeight);
        this.replaceSequence(layerData, [sMR, 0], [sMR, sBR], mapHeight);
        this.replaceSequence(layerData, [sMR, p], [cTR, p], mapHeight);
        this.replaceSequence(layerData, [p, sMR], [p, cBR], mapHeight);
        this.replaceSequence(layerData, [p, sML], [p, cBL], mapHeight);
        this.replaceSequence(layerData, [sML, p], [cTL, p], mapHeight);
        this.replaceSequence(layerData, [0, sMR], [sTR, sMR], mapHeight);
        this.replaceSequence(layerData, [cBL, 0], [cBL, sBL], mapHeight);
        this.replaceSequence(layerData, [0, cBL], [sTR, cBL], mapHeight);
        this.replaceSequence(layerData, [0, cTL], [sTL, cTL], mapHeight);
        layerData = this.rollbackRotation90Degrees(layerData, mapHeight, mapWidth);
        // restore rotation and fix round corners:
        this.replaceSequence(layerData, [sMR, sBL], [cBR, sBL], mapWidth);
        this.replaceSequence(layerData, [sTL, sML], [sTL, cTL], mapWidth);
        this.replaceSequence(layerData, [sMR, sBR], [cBR, sBR], mapWidth);
        this.replaceSequence(layerData, [sBL, sML], [sBL, cBL], mapWidth);
        this.replaceSequence(layerData, [sMR, sTR], [cTR, sTR], mapWidth);
        this.replaceSequence(layerData, [cTR, 0], [cTR, sTR], mapWidth);
        this.replaceSequence(layerData, [cTR, p], [p, p], mapWidth);
        this.replaceSequence(layerData, [p, cBL], [p, p], mapWidth);
        this.replaceSequence(layerData, [cTR, cBL], [p, p], mapWidth);
        this.replaceSequence(layerData, [cBR, sBL], [cBR, sBR], mapWidth);
        layerData = this.rotateLayer90Degrees(layerData, mapHeight, mapWidth);
        this.replaceSequence(layerData, [cBL, cBL], [cBL, sBL], mapHeight);
        this.replaceSequence(layerData, [cTR, cTR], [cTR, sTR], mapHeight);
        this.replaceSequence(layerData, [sBL, sBL], [sBL, cBL], mapHeight);
        this.replaceSequence(layerData, [sBR, sBR], [sBR, cTR], mapHeight);
        this.replaceSequence(layerData, [sTL, sTL], [sTL, cTL], mapHeight);
        this.replaceSequence(layerData, [sTR, sTR], [sTR, cTR], mapHeight);
        this.replaceSequence(layerData, [cBR, cBR], [cBR, sMR], mapHeight);
        this.replaceSequence(layerData, [cBL, cBL], [cBL, sML], mapHeight);
        this.replaceSequence(layerData, [sMR, cBR, sMR], [sMR, sMR, sMR], mapHeight);
        this.replaceSequence(layerData, [sML, sBR, 0], [sML, sBL, 0], mapHeight);
        this.replaceSequence(layerData, [sBC, cBR, cBL], [sBC, sBC, cBL], mapHeight);
        layerData = this.rollbackRotation90Degrees(layerData, mapHeight, mapWidth);
        return layerData;
    }
            ...
            for(let i = 0; i < spotsQuantity; i++){
                ...
                if(groundSpotConfig.applyCornersTiles){
                    ...
                    if(groundSpotConfig.borderInnerWalls){
                        wallsLayer = this.createSpotInnerWalls(bordersLayer, tilesKey, spotTilesShortcuts);
                    }
                    if(groundSpotConfig.borderOuterWalls){
                        let result = await this.createSpotOuterWalls(
                            bordersLayer,
                            tilesKey,
                            spotTilesShortcuts,
                            wallsLayer
    ...
    async createSpotOuterWalls(bordersLayer, tilesKey, spotTiles, wallsLayer)
    {
        let outerWallsTiles = this.fetchTilesShortcutsBySuffix(tilesKey, spotTiles, '-outer-walls');
        let width = Math.sqrt(bordersLayer.length);
        let height = bordersLayer.length / width;
    ...
    applyPatternsThroughMerge(outerWallsLayer, bordersLayer, mapWidth, mapHeight, spotTiles, outerTiles)
    {
        ...
        this.replaceSequence(mergedLayers, [sBC, 0, cBL], [sBC, sBC, cBL], mapWidth);
        this.replaceSequence(mergedLayers, [cBR, 0, sBC], [cBR, sBC, sBC], mapWidth);
        this.replaceSequence(mergedLayers, [sMR, 0, sBC], [sMR, sBL, sBC], mapWidth);
        this.replaceSequence(mergedLayers, [sMR, sBR, sBC], [sMR, sBL, sBC], mapWidth);
        this.replaceSequence(mergedLayers, [sMR, sTR, cTL], [sMR, sMR, cTL], mapWidth);
        this.replaceSequence(mergedLayers, [0, sMR, 0, 0], [0, sMR, sML, 0], mapWidth);
        this.replaceSequence(mergedLayers, [0, 0, sML, 0], [0, sMR, sML, 0], mapWidth);
        this.replaceSequence(mergedLayers, [cBR, cBR, cBL, 0], [cBR, cBL, 0, 0], mapWidth);
        this.replaceSequence(mergedLayers, [cBR, sBC, cBR, cBL, 0], [cBR, cBL, 0, 0, 0], mapWidth);
        this.replaceSequence(mergedLayers, [cTR, 0, sML], [cTR, sTR, sML], mapWidth);
        this.replaceSequence(mergedLayers, [sTC, sTR, cTL], [sTC, sTC, cTL], mapWidth);
        this.replaceSequence(mergedLayers, [cBR, cBL, cBL], [0, cBR, cBL], mapWidth);
        this.replaceSequence(mergedLayers, [sMR, sBL, cBR, sBC], [sMR, sBL, sBC, sBC], mapWidth);
        this.replaceSequence(mergedLayers, [cBR, sTC, cTL], [0, cTR, cTL], mapWidth);
        this.replaceSequence(mergedLayers, [sMR, 0, cTL], [sMR, sTL, cTL], mapWidth);
        this.replaceSequence(mergedLayers, [cTR, sTR, cTL], [cTR, sTC, cTL], mapWidth);
        this.replaceSequence(mergedLayers, [sTC, cBL, sML], [sTC, sBR, sML], mapWidth);
        this.replaceSequence(mergedLayers, [sBC, cBL, sML], [sBC, sBR, sML], mapWidth);
        this.replaceSequence(mergedLayers, [sMR, sBL, cBL, sML], [sMR, sBL, sBR, sML], mapWidth);
        // rotate:
        this.rotateLayer90Degrees(mergedLayers, mapWidth, mapHeight);
        this.replaceSequence(mergedLayers, [sMR, cTR, cBR, sMR], [sMR, sMR, sMR, sMR], mapWidth);
        this.replaceSequence(mergedLayers, [sML, cTL, cBL, sML], [sML, sML, sML, sML], mapWidth);
        this.replaceSequence(mergedLayers, [cBR, 0, cTR], [cBR, sMR, cTR], mapWidth);
        ...
        this.replaceSequence(mergedLayers, [sML, cTL, cBL], [sML, sML, sML], mapWidth);
        this.replaceSequence(mergedLayers, [sML, 0, cTL], [sML, sML, cTL], mapWidth);
        this.replaceSequence(mergedLayers, [cBL, 0, cTL], [cBL, sML, cTL], mapWidth);
        // and rollback:
        this.rollbackRotation90Degrees(mergedLayers, mapWidth, mapHeight);
        this.replaceSequence(mergedLayers, [cTR, cTL, cBL, cTL], [cTR, sBC, sBC, cTL], mapWidth);
        this.replaceSequence(
            mergedLayers,
        ...
        this.replaceSequence(mergedLayers, [cBR, 0, cBL], [cBR, sBC, cBL], mapWidth);
        this.replaceSequence(mergedLayers, [sMR, sBL, outerTiles.sMC], [sMR, sML, outerTiles.sMC], mapWidth);
        this.replaceSequence(mergedLayers, [cTR, sTL, cTL], [cTR, sTC, cTL], mapWidth);
        this.replaceSequence(mergedLayers, [sTR, sBR, cBL], [sTR, sBL, cBL], mapWidth);
        this.replaceSequence(mergedLayers, [sMR, cBR, sBR], [sMR, sBL, sBR], mapWidth);
        this.replaceSequence(mergedLayers, [sMR, sBR, cBL], [sMR, sBL, cBL], mapWidth);
        this.replaceSequence(mergedLayers, [sTC, cTR, cTL], [sTC, sTC, cTL], mapWidth);
        this.replaceSequence(
            mergedLayers,
            [outerTiles.sMC, outerTiles.sMR, outerTiles.sML],
            [outerTiles.sMC, outerTiles.sMC, outerTiles.sML],
            mapWidth
        );
        this.replaceSequence(
            mergedLayers,
            [outerTiles.sBC, outerTiles.cBR, outerTiles.cBL],
            [outerTiles.sBC, outerTiles.sBC, outerTiles.cBL],
            mapWidth
        );
        this.replaceSequence(mergedLayers, [sMR, cBR, sBC], [sMR, sBL, sBC], mapWidth);
        this.replaceSequence(mergedLayers, [sBC, cBL, sBC], [sBC, sBC, sBC], mapWidth);
        if(outerTc){
            this.replaceSequence(mergedLayers, [sMR, 0, sML], [sMR, outerTc, sML], mapWidth);
            this.replaceSequence(mergedLayers, [sBR, 0, sML], [sBR, outerTc, sML], mapWidth);
            this.replaceSequence(mergedLayers, [sTR, 0, sML], [sTR, outerTc, sML], mapWidth);
            this.replaceSequence(mergedLayers, [sTR, 0, sBR], [sTR, outerTc, sBR], mapWidth);
            this.replaceSequence(mergedLayers, [sBR, 0, sBL], [sBR, outerTc, sBL], mapWidth);
            this.replaceSequence(mergedLayers, [sMR, 0, sBR], [sMR, outerTc, sBR], mapWidth);
            this.replaceSequence(mergedLayers, [sMR, 0, sTR], [sMR, outerTc, sTR], mapWidth);
            this.replaceSequence(mergedLayers, [sMR, 0, sBL], [sMR, outerTc, sBL], mapWidth);
            this.replaceSequence(mergedLayers, [sTR, 0, sTL], [sTR, outerTc, sTL], mapWidth);
            this.replaceSequence(mergedLayers, [sMR, sMR, sML], [sMR, outerTc, sML], mapWidth);
            this.replaceSequence(mergedLayers, [sTR, sMR, sBR], [sTR, outerTc, sBR], mapWidth);
            this.replaceSequence(mergedLayers, [cBR, sBC, 0, sMR], [cBR, outerTc, outerTc, sMR], mapWidth);
            this.replaceSequence(mergedLayers, [sMR, 0, 0, sTL], [sMR, outerTc, outerTc, sTL], mapWidth);
            this.replaceSequence(mergedLayers, [sTR, sMR, sTL], [sTR, outerTc, sTL], mapWidth);
            this.replaceSequence(mergedLayers, [sMR, 0, sTL], [sMR, outerTc, sTL], mapWidth);
            this.replaceSequence(mergedLayers, [sTC, 0, sTL], [sTR, outerTc, sTL], mapWidth);
            this.replaceSequence(mergedLayers, [sBR, sMR, sML], [sBR, outerTc, sML], mapWidth);
            this.replaceSequence(mergedLayers, [sMR, sBC, 0, sTL], [sMR, outerTc, outerTc, sTL], mapWidth);
            this.replaceSequence(mergedLayers, [sMR, sMR, sBL], [sMR, outerTc, sBL], mapWidth);
            this.replaceSequence(mergedLayers, [sBR, sMR, sBL], [sBR, outerTc, sBL], mapWidth);
            this.replaceSequence(mergedLayers, [sMR, sBC, sBC, sML], [sMR, outerTc, outerTc, sML], mapWidth);
            this.replaceSequence(mergedLayers, [sBR, sBC, sBC, 0, sML], [sBR, outerTc, outerTc, outerTc, sML], mapWidth);
            this.replaceSequence(mergedLayers, [sTR, sMR, sML], [sTR, outerTc, sML], mapWidth);
            this.replaceSequence(mergedLayers, [sTR, sBC, 0, sML], [sTR, outerTc, outerTc, sML], mapWidth);
            this.replaceSequence(mergedLayers, [cTR, 0, sTL], [sMR, outerTc, sTL], mapWidth);
            this.replaceSequence(mergedLayers, [0, sMR, cTL, cBL, sML, 0], [0, sMR, outerTc, outerTc, sML, 0], mapWidth);
            this.replaceSequence(mergedLayers, [sMR, sMR, cBL], [sMR, outerTc, cBL], mapWidth);
            this.replaceSequence(mergedLayers, [sMR, sBC, sBC, 0, sML], [sMR, outerTc, outerTc, outerTc, sML], mapWidth);
            this.replaceSequence(mergedLayers, [sMR, sBL, sBC, sML], [sMR, outerTc, outerTc, sML], mapWidth);
            this.replaceSequence(mergedLayers, [sBR, sBC, 0, sBL], [sBR, outerTc, outerTc, sBL], mapWidth);
            this.replaceSequence(mergedLayers, [sTR, 0, sMR, sML], [sTR, outerTc, outerTc, sML], mapWidth);
            this.replaceSequence(mergedLayers, [sMR, sMR, sTL], [sMR, outerTc, sTL], mapWidth);
            this.replaceSequence(mergedLayers, [sTR, 0, sBL], [sTR, outerTc, sBL], mapWidth);
            this.replaceSequence(mergedLayers, [sMR, cBR, sTL], [sMR, outerTc, sTL], mapWidth);
            this.replaceSequence(mergedLayers, [sMR, outerTc, sBR, sML], [sMR, outerTc, outerTc, sML], mapWidth);
            this.replaceSequence(mergedLayers, [sMR, cBL, 0], [sMR, outerTc, cTL], mapWidth);
            this.replaceSequence(mergedLayers, [sMR, sML, cBR, sBC, 0, sML], [sMR, outerTc, outerTc, outerTc, outerTc, sML], mapWidth);
            this.replaceSequence(mergedLayers, [sMR, sBL, sBC, sBC, sML], [sMR, outerTc, outerTc, outerTc, sML], mapWidth);
            this.replaceSequence(mergedLayers, [sMR, sML, 0, sTL], [sMR, outerTc, outerTc, sTL], mapWidth);
            this.replaceSequence(mergedLayers, [sMR, sBC, 0, sML], [sMR, outerTc, outerTc, sML], mapWidth);
            this.replaceSequence(mergedLayers, [sMR, outerTc, sBL, sML], [sMR, outerTc, outerTc, sML], mapWidth);
            this.replaceSequence(mergedLayers, [cBR, sBR, sBC, 0, sML], [cBR, sBR, outerTc, outerTc, sML], mapWidth);
            this.replaceSequence(mergedLayers, [sMR, sBL, 0, sML], [sMR, outerTc, outerTc, sML], mapWidth);
            this.replaceSequence(mergedLayers, [sMR, sML, sMR, sBL], [sMR, outerTc, outerTc, sBL], mapWidth);
            this.replaceSequence(mergedLayers, [sTR, sBL, sBR, sTL], [sTR, outerTc, outerTc, sTL], mapWidth);
            this.replaceSequence(mergedLayers, [sMR, sML, sMR, sML], [sMR, outerTc, outerTc, sML], mapWidth);
            this.replaceSequence(mergedLayers, [sMR, sBL, cBL, sML], [sMR, outerTc, outerTc, sML], mapWidth);
            this.replaceSequence(mergedLayers, [sMR, sBL, cBL, sBL], [sMR, outerTc, outerTc, sBL], mapWidth);
            this.replaceSequence(mergedLayers, [sBR, sBC, cBL, sML], [sBR, outerTc, outerTc, sML], mapWidth);
        }
        this.replaceSequence(mergedLayers, [sBC, 0], [sBC, cBL], mapWidth);
        this.replaceSequence(mergedLayers, [sBC, cBL, cBR], [sBC, sBC, cBL], mapWidth);
        this.replaceSequence(mergedLayers, [cTR, cTL, cTL], [cTR, sTC, cTL], mapWidth);
        this.replaceSequence(mergedLayers, [sBC, cBL, sBC], [sBC, sBC, sBC], mapWidth);
        this.replaceSequence(mergedLayers, [sBC, cBL, sBR, sML], [sBC, sBC, sBR, sML], mapWidth);
        this.replaceSequence(mergedLayers, [sTR, cBR, sBC], [sTR, sBL, sBC], mapWidth);
        this.replaceSequence(
            mergedLayers,
            [outerTiles.sML, outerTiles.sMR, outerTiles.sMR],
            [outerTiles.sML, outerTiles.sMC, outerTiles.sMR],
            mapWidth
        );
        this.replaceSequence(
            mergedLayers,
            [outerTiles.cBL, outerTiles.cBR, outerTiles.cBR],
            [outerTiles.cBL, outerTiles.sBC, outerTiles.cBR],
            mapWidth
        );
        this.replaceSequence(
            mergedLayers,
            [outerTiles.sMC, outerTiles.sML, outerTiles.sMR],
            [outerTiles.sMC, outerTiles.sMC, outerTiles.sMR],
            mapWidth
        );
        this.replaceSequence(
            mergedLayers,
            [outerTiles.sBC, outerTiles.cBL, outerTiles.cBR],
            [outerTiles.sBC, outerTiles.sBC, outerTiles.cBR],
            mapWidth
        );
        ...
        for(let i = 0; i < mergedLayers.length; i++){
            ...
            if(cBR === mergedLayers[i] && (outerTiles.sMC === mergedLayers[i - 1] || outerTiles.sML === mergedLayers[i - 1])){
                bordersLayer[i] = outerTiles.sMC;
            }
            if(cBL === mergedLayers[i] && (outerTiles.sMC === mergedLayers[i + 1] || outerTiles.sMR === mergedLayers[i + 1])){
                bordersLayer[i] = outerTiles.sMC;
            }
        }
    ...
    applyOuterWallsPatterns(outerWallsLayer, mapWidth, mapHeight, spotTiles, outerTiles)
    {
        ...
        let {p, tC, sTL, sTC, sTR, sMC, sML, sMR, sBL, sBC, sBR, cTL, cTR, cBL, cBR} = spotTiles;
        // fix patterns:
        this.replaceSequence(fixedLayer, [sML, cTL], [sTC, cTL], mapWidth);
        this.replaceSequence(fixedLayer, [cTR, sMR], [cTR, sTR], mapWidth);
        this.replaceSequence(fixedLayer, [sML, sTC], [sTL, sTC], mapWidth);
        this.replaceSequence(fixedLayer, [sTC, sMR], [sTC, sTR], mapWidth);
        this.replaceSequence(fixedLayer, [sTC, cBR], [sTC, sTR], mapWidth);
        this.replaceSequence(fixedLayer, [sBC, 0], [sTL, 0], mapWidth);
        this.replaceSequence(fixedLayer, [0, sBC], [0, sBL], mapWidth);
        // fix loose corners:
        ...
        this.replaceSequence(fixedLayer, [sML, cBL, sML], [sML, sML, sML], mapWidth);
        this.replaceSequence(fixedLayer, [sMR, cBR, sMR], [sMR, sMR, sMR], mapWidth);
        this.replaceSequence(fixedLayer, [sMR, sBC], [sMR, sBR], mapWidth);
        this.replaceSequence(fixedLayer, [sBC, cBR], [sBC, sBC], mapWidth);
        this.replaceSequence(fixedLayer, [sTC, sBL], [sTL, sBL], mapWidth);
        this.replaceSequence(fixedLayer, [0, cBR, cBL, 0], [0, cBR, sBR, 0], mapWidth);
        this.replaceSequence(fixedLayer, [0, sTR, sBC, 0], [0, sTR, sBR, 0], mapWidth);
        this.replaceSequence(fixedLayer, [sMR, cBR, 0], [sMR, sBR, 0], mapWidth);
        this.replaceSequence(fixedLayer, [sML, cBR, 0], [sML, sBL, 0], mapWidth);
        this.replaceSequence(fixedLayer, [cBR, sTR, cBL, 0], [cBR, sTR, sTL, 0], mapWidth);
        this.replaceSequence(fixedLayer, [sML, 0, sBL], [sML, sML, sBL], mapWidth);
        this.replaceSequence(fixedLayer, [0, sTL, cTL, sML], [0, sTL, sML, sML], mapWidth);
        this.replaceSequence(fixedLayer, [0, sTL, cTR, sML], [0, sTL, sML, sML], mapWidth);
        this.replaceSequence(fixedLayer, [0, sTR, cTL, sMR], [0, sTR, sMR, sMR], mapWidth);
        this.replaceSequence(fixedLayer, [0, sTR, cTR, sMR], [0, sTR, sMR, sMR], mapWidth);
        this.replaceSequence(fixedLayer, [0, cTR, cTL, 0], [0, cTR, sBR, 0], mapWidth);
        // rotate back:
        fixedLayer = this.rollbackRotation90Degrees(fixedLayer, mapHeight, mapWidth);
        // fix remaining patters:
        this.replaceSequence(fixedLayer, [0, sTC, cTL], [0, sTL, cTL], mapWidth);
        this.replaceSequence(fixedLayer, [0, sBC, cBL], [0, sBL, cBL], mapWidth);
        this.replaceSequence(fixedLayer, [0, cTR, cBR], [0, cTR, sBR], mapWidth);
        this.replaceSequence(fixedLayer, [sBC, sTL, sMR], [sBC, sBR, sMR], mapWidth);
        this.replaceSequence(fixedLayer, [sTC, cTL, sTC], [sTC, sTC, sTC], mapWidth);
        this.replaceSequence(fixedLayer, [sBC, cBL, sBC], [sBC, sBC, sBC], mapWidth);
        this.replaceSequence(
            fixedLayer,
            [outerTiles.sMC, outerTiles.sMR, outerTiles.sMC],
            [outerTiles.sMC, outerTiles.sMC, outerTiles.sMC],
            mapWidth
        );
        this.replaceSequence(
            fixedLayer,
            [outerTiles.sTC, outerTiles.cTL, outerTiles.sTC],
            [outerTiles.sTC, outerTiles.sTC, outerTiles.sTC],
            mapWidth
        );
        this.replaceSequence(fixedLayer, [sTC, cTR], [sTC, sTC], mapWidth);
        this.replaceSequence(fixedLayer, [outerTiles.sMC, outerTiles.sML], [outerTiles.sMC, outerTiles.sMC], mapWidth);
        this.replaceSequence(fixedLayer, [outerTiles.sTC, outerTiles.cTR], [outerTiles.sTC, outerTiles.sTC], mapWidth);
        this.replaceSequence(fixedLayer, [sTC, cBR], [sTC, sTR], mapWidth);
        this.replaceSequence(fixedLayer, [sTL, cBL, sBL], [sTL, sML, sBL], mapWidth);
        this.replaceSequence(fixedLayer, [cBL, cTL], [sTL, cTL], mapWidth);
        this.replaceSequence(fixedLayer, [0, sTC, 0], [0, 0, 0], mapWidth);
        this.replaceSequence(fixedLayer, [sTC, cBR, sTC], [sTC, sTC, sTC], mapWidth);
        this.replaceSequence(fixedLayer, [sTL, cBR, sBR], [sTL, sBL, sBR], mapWidth);
        this.replaceSequence(fixedLayer, [sBC, cBR, sBC], [sBC, sBC, sBC], mapWidth);
        this.replaceSequence(fixedLayer, [sBC, cBL, sBC], [sBC, sBC, sBC], mapWidth);
        this.replaceSequence(fixedLayer, [sBC, cBR, sTL], [sBC, sBR, sTL], mapWidth);
        this.replaceSequence(fixedLayer, [0, sBL, sTR, 0], [0, sBL, sBR, 0], mapWidth);
        this.replaceSequence(fixedLayer, [sBC, 0, sBC], [sBC, sBC, sBC], mapWidth);
        this.replaceSequence(fixedLayer, [sTR, cBR, sTL], [sTR, sMR, sBR], mapWidth);
        this.replaceSequence(fixedLayer, [0, sBR, sBC], [0, sBL, sBC], mapWidth);
        this.replaceSequence(fixedLayer, [0, cBR, sBL, 0], [0, cBR, sBR, 0], mapWidth);
        this.replaceSequence(fixedLayer, [0, cBL, sTC], [0, sTL, sTC], mapWidth);
        this.replaceSequence(fixedLayer, [0, cTR, sBR], [0, cTR, sTR], mapWidth);
        this.replaceSequence(fixedLayer, [sBC, sTL, 0], [sBC, sBR, 0], mapWidth);
        this.replaceSequence(fixedLayer, [outerTiles.sMC, cBR, 0], [outerTiles.sMC, sMR, 0], mapWidth);
        this.replaceSequence(fixedLayer, [outerTiles.sML, cBR, 0], [outerTiles.sML, sMR, 0], mapWidth);
        this.replaceSequence(fixedLayer, [outerTiles.sMR, cBL, 0], [outerTiles.sMR, sML, 0], mapWidth);
        this.replaceSequence(fixedLayer, [sBL, sTL], [sBL, sBR], mapWidth);
        this.replaceSequence(fixedLayer, [0, cBR, outerTiles.sMR], [0, sMR, outerTiles.sMR], mapWidth);
        this.replaceSequence(fixedLayer, [0, cBL, outerTiles.sML], [0, sML, outerTiles.sML], mapWidth);
        // rotate:
        fixedLayer = this.rotateLayer90Degrees(fixedLayer, mapWidth, mapHeight);
        this.replaceSequence(fixedLayer, [sML, 0, sBR], [sML, sML, sBL], mapWidth);
        this.replaceSequence(fixedLayer, [sMR, 0, sBL], [sMR, sMR, sBR], mapWidth);
        this.replaceSequence(fixedLayer, [0, cBR, cBL], [0, cBR, sBR], mapWidth);
        this.replaceSequence(fixedLayer, [sMR, cBR, sBR], [sMR, sMR, sBR], mapWidth);
        this.replaceSequence(fixedLayer, [0, cBL, cBR], [0, cBL, sBL], mapWidth);
        this.replaceSequence(fixedLayer, [sML, cTL, sBL], [sML, sML, sBL], mapWidth);
        this.replaceSequence(fixedLayer, [sML, cTL, sBL], [sML, sML, sBL], mapWidth);
        this.replaceSequence(fixedLayer, [sTL, cBL, sBL], [sTL, sML, sBL], mapWidth);
        this.replaceSequence(fixedLayer, [sTL, cBL, sML], [sTL, sML, sML], mapWidth);
        this.replaceSequence(fixedLayer, [sTL, cBL, 0], [sTL, sBL, 0], mapWidth);
        this.replaceSequence(fixedLayer, [0, sMR, sMR, sTC, outerTiles.sMC], [0, 0, 0, sTC, outerTiles.sMC], mapWidth);
        this.replaceSequence(fixedLayer, [sML, cBL, sBL], [sML, sML, sBL], mapWidth);
        this.replaceSequence(fixedLayer, [sML, cBL, sML], [sML, sML, sML], mapWidth);
        this.replaceSequence(fixedLayer, [cBR, cBL, 0], [cBR, sBR, 0], mapWidth);
        this.replaceSequence(fixedLayer, [sMR, cBL, sMR], [sMR, sBR, sMR], mapWidth);
        // rollback:
        fixedLayer = this.rollbackRotation90Degrees(fixedLayer, mapHeight, mapWidth);
        this.replaceSequence(fixedLayer, [sBC, cBR, sBR], [sBC, sBC, sBR], mapWidth);
        this.replaceSequence(fixedLayer, [0, cBR, sTL, 0], [0, cBR, sBR, 0], mapWidth);
        this.replaceSequence(fixedLayer, [sTL, cBL, sML], [sTL, sML, sML], mapWidth);
        this.replaceSequence(fixedLayer, [sBC, 0, sBR], [sBC, sBC, sBR], mapWidth);
        this.replaceSequence(fixedLayer, [sBL, 0, sBC], [sBL, sBC, sBC], mapWidth);
        this.replaceSequence(fixedLayer, [cTR, cBR, 0], [cTR, sTR, 0], mapWidth);
        this.replaceSequence(fixedLayer, [sBL, sBR, cTL, outerTiles.sMR], [0, sTL, cTL, outerTiles.sMR], mapWidth);
        this.replaceSequence(fixedLayer, [0, sBL, sBR, cTL, 0], [0, 0, sTL, cTL, 0], mapWidth);
        this.replaceSequence(fixedLayer, [0, sBL, cBL, sTC], [0, 0, sTL, sTC], mapWidth);
        this.replaceSequence(fixedLayer, [sTL, 0, sTR], [sTL, sTC, sTR], mapWidth);
        this.replaceSequence(fixedLayer, [sMR, sTR, cBR], [sMR, sTL, cBR], mapWidth);
        this.replaceSequence(fixedLayer, [sTR, 0, sTL], [sTR, sTC, sTL], mapWidth);
        this.replaceSequence(fixedLayer, [sTL, 0, sTR], [sTL, sTC, sTR], mapWidth);
        this.replaceSequence(fixedLayer, [sBR, 0, sBL], [sBR, sBC, sBL], mapWidth);
        this.replaceSequence(fixedLayer, [sBL, 0, sBR], [sBL, sBC, sBR], mapWidth);
        return fixedLayer;
    }

    replaceCornersPatters(fixedLayer, mapWidth, spotTiles, outerTiles)
    {
        this.replaceSequences(fixedLayer, [
    ...
    async placeOuterWallTile(outerWallsLayer, x, y, width, oppositeTiles, oppositePositions, wallsLayer, bordersLayer)
    {
    ...
    createSpotInnerWalls(bordersLayer, tilesKey, spotTilesShortcuts)
    {
    ...
    createRandomPathLayer(groundSpotConfig, spotTile, bordersLayer, spotLayer, spotTilesShortcuts)
    {
        ...
        let pathTileIndexes = this.fetchPathTileIndexes(borderTiles, groundSpotConfig);
        ...
        this.applyBorderEndTiles(bordersLayer, pathTileIndexes, removedBorders, spotTilesShortcuts, groundSpotConfig);
        return {
            height: groundSpotConfig.height,
            name: 'path',
            opacity: 1,
    ...
    fetchPathTileIndexes(borderTiles, groundSpotConfig)
    {
        if(1 < this.pathSize){
            let sequences = this.findContinuousBorderSequences(
                borderTiles,
                groundSpotConfig.width,
                groundSpotConfig.height,
                this.pathSize
    ...
    applyBorderEndTiles(bordersLayer, pathTileIndexes, removedBorders, spotTiles, groundSpotConfig)
    {
        let layerWidth = groundSpotConfig.width;
    ...
    {
        let minDistanceInTiles = groundSpotConfig.borderOuterWalls ? 5 : 1;
        ...
        for(let i = 0; i < borderTiles.length; i++){
            ...
            let distToEdge = Math.min(
                x,
                groundSpotConfig.width - minDistanceInTiles - x,
                y,
                groundSpotConfig.height - minDistanceInTiles - y
            );
            if(0 === distToEdge){
