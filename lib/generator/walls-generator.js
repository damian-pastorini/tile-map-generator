...
class WallsGenerator
{
    ...
    determineWallTiles(innerWallsTilesShortcuts, spotTilesShortcuts, currentTile)
    {
        ...
        if(currentTile === spotTilesShortcuts.cTL){
            return this.fetchResolvedWallTiles(innerWallsTilesShortcuts.sML, innerWallsTilesShortcuts.cTL);
        }
        if(currentTile === spotTilesShortcuts.sTC){
            return this.fetchResolvedWallTiles(innerWallsTilesShortcuts.sMC, innerWallsTilesShortcuts.sTC);
        }
        return this.fetchResolvedWallTiles(innerWallsTilesShortcuts.sMR, innerWallsTilesShortcuts.cTR);
    }

    fetchResolvedWallTiles(middleWallTile, topWallTile)
    {
