...
class PathConnector
{
    ...
    constructor(generator)
    {
        ...
        this.generatedMainPathIndexes = generator.generatedMainPathIndexes;
        this.generatedMainPathIndexesBorder = generator.generatedMainPathIndexesBorder;
        this.generatedReturnPoints = generator.generatedReturnPoints;
        this.pathLayerProperties = generator.pathLayerProperties;
        this.hasAssociatedMap = generator.hasAssociatedMap;
        this.mainPathStart = generator.mainPathStart;
        this.pathLayerData = generator.pathLayerData;
        this.mapGrid = generator.mapGrid;
        ...
        this.fetchTilesShortcutsBySuffix = generator.fetchTilesShortcutsBySuffix.bind(generator);
        this.applySplitBordersAndCorners = generator.spotGenerator.applySplitBordersAndCorners.bind(generator.spotGenerator);
        ...
        this.determineReturnPointFromMainPath = generator.determineReturnPointFromMainPath.bind(generator);
        this.cleanUpMapBorders = generator.cleanUpMapBorders.bind(generator);
    }
    ...
    async connectPaths(
        ...
        if(outerWallsResult?.outerWallsLayer && outerWallsResult?.bordersLayer){
            ...
            pathInnerWallsLayer = this.fixInnerWallsPatterns(
                pathInnerWallsLayer,
                this.fetchTilesShortcutsBySuffix(this.pathsInnerWallsTilesKey, tilesShortcuts, '-inner-walls'),
                mapWidth,
                mapHeight
            );
        }
        splitBorderLayer = this.cleanUpMapBorders(splitBorderLayer, tilesShortcuts);
        this.markPathTilesAsUnavailable(splitBorderLayer, pathLayerData, mapGrid, mapWidth, mapHeight);
