...
class PathConnector
{
    ...
    constructor(generator)
    {
        ...
        this.applySplitBordersAndCorners = generator.applySplitBordersAndCorners.bind(generator);
        this.applyBorderEndTiles = generator.applyBorderEndTiles.bind(generator);
    ...
    async connectPaths(
        ...
        splitBorderLayer = this.cleanUpMapBorders(splitBorderLayer, mapWidth, mapHeight, tilesShortcuts);
        this.markPathTilesAsUnavailable(splitBorderLayer, pathLayerData, mapGrid, mapWidth, mapHeight);
    ...
    isBorder(tilePosition, mapWidth, mapHeight)
    {
        return 0 >= tilePosition.x
            || 0 >= tilePosition.y
            || mapWidth === tilePosition.x
            || mapHeight === tilePosition.y;
    }
    ...
    cleanUpMapBorders(bordersLayer, mapWidth, mapHeight, tilesShortcuts)
    {
