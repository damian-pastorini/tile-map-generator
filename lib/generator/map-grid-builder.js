...
class MapGridBuilder
{
    ...
    createPathfindingGrid(pathFinder, mapWidth, mapHeight, temporalBlockedPositionsToAvoidElements, additionalLayers, collisionLayersForPaths, mapGrid, tileIndexByRowAndColumn)
    {
        let debugLayerData = {};
