...
class DebugHelper
{
    ...
    constructor(generator)
    {
        ...
        this.createTiledMapObject = generator.createTiledMapObject.bind(generator);
        this.placementOffsets = generator.placementOffsets.bind(generator);
    }
    ...
    async writeDebugPathFinderFile(layers, layerNamePrefix = 'test-', debugLayerData)
    {
        ...
        layersCloned.push(this.generateLayerWithData('path-finder-collisions', Object.values(debugLayerData)));
