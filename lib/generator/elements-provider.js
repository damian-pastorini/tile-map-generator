...
class ElementsProvider
{
    ...
    constructor(props)
    {
        ...
        this.defaultMapName = 'elements-'+this.currentDate;
        this.mapName = sc.get(props, 'mapName', this.defaultMapName);
    ...
    async optimizeMap()
    {
        let options = {
            ...
            newName: 'optimized-'+this.mapName,
            factor: this.factor,
            transparentColor: this.transparentColor,
            rootFolder: this.rootFolder
        };
        this.tileMapOptimizer = new TileMapOptimizer(options);
        if (!this.tileMapOptimizer.isReady){
            Logger.error('TileMapOptimizer is not ready, there are missing options.', options);
            return false;
        }
