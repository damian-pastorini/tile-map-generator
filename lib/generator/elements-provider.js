...
class ElementsProvider
{
    ...
    constructor(props)
    {
        ...
        this.optimizedFolder = FileHandler.joinPaths(this.generatedFolder, GeneratedFoldersConstants.OPTIMIZED_SUB_FOLDER);
    ...
    expandLayers(layers)
    {
        for(let layer of layers){
            ...
            // new dimensions, the x2 is to center the element:
