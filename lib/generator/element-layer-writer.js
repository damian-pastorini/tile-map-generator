...
class ElementLayerWriter
{
    ...
    updateLayerData(elementData, elementNumber, baseElementData, elementType)
    {
        ...
        if(-1 === layerIndex){
            ...
            layerIndex = this.generator.additionalLayers.length - 1;
        }
    ...
    updateLayerChangePointsData(
        ...
        this.generator.generatedChangePoints[elementKey] = {
            elementData,
            tileIndex,
            mapIndex,
            elementNumber,
    ...
    updateLayerWithReturnPointsData(
        ...
        this.generator.generatedReturnPoints[elementKey] = {
            tileIndex,
        ...
        let type = 'int';
        this.generator.pathLayerProperties.push(
