...
class MapLayersComposer
{
    ...
    generateLayersList()
    {
        ...
        if(this.generator.applyMapBorderInnerWalls && sc.isArray(this.generator.borderWallsLayer)){
            this.generator.staticLayers.push(
                this.generator.generateLayerWithData(
                    'map-border-inner-walls'+this.generator.mapBorderWallsLayerSuffix,
    ...
    mergeLayersByNameSubstring(layers, matchKey)
    {
        ...
        return this.generator.layerDataFactory.mergeLayersByNameSubstring(layers, matchKey);
    }
